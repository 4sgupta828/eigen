...
## 6. Claims-first comprehensive extraction (flag: `EIGEN_CLAIMS_FIRST`)
...
## 7. Evidence selection (flag: `EIGEN_EVIDENCE_SELECT`)
...
The streaming variant `/research/stream` (`app.py:497-539`, flag `EIGEN_STREAM`)
