...
Usage:
  EIGEN_CORPUS_DSN=postgresql://…/eigen  python scripts/run_claim_extract.py            # dry run
  EIGEN_CORPUS_DSN=…  python scripts/run_claim_extract.py --source yc --limit 200       # dry run, scoped
  EIGEN_CORPUS_DSN=…  python scripts/run_claim_extract.py --live --max-usd 2            # SPEND (capped)
"""
...
def main() -> int:
    ...
    if not dsn:
        print("ERROR: set EIGEN_CORPUS_DSN", file=sys.stderr)
        return 2
