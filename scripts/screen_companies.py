...
Usage:  EIGEN_HTTP_CONTACT=you@example.com .venv/bin/python scripts/screen_companies.py [N] > universe.json
"""
...
UA = {"User-Agent": f"eigen-research/0.1 ({os.environ.get('EIGEN_HTTP_CONTACT', 'research@eigen.dev')})"}
