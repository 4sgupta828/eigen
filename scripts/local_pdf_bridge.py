...
Stdlib only (no project deps) so it runs with any python3. Usage:
  EIGEN_ADMIN_TOKEN=... python scripts/local_pdf_bridge.py --seminal
  EIGEN_ADMIN_TOKEN=... python scripts/local_pdf_bridge.py 2005.11401 1706.03762 1412.6980
  EIGEN_ADMIN_TOKEN=... python scripts/local_pdf_bridge.py --from-file ids.txt   # one arxiv id per line
...
def main() -> int:
    ...
    token = os.environ.get("EIGEN_ADMIN_TOKEN", "")
    if not token:
