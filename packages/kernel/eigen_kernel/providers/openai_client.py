...
eigen's cross-family GROUNDING GATE (research/grounding_gate.py) and the derive VALIDITY JUDGE
...
pydantic `response_format.model_json_schema()` (non-strict — eigen's judge shapes default their
