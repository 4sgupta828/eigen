...
from eigen_kernel.facets.contract_search import collapsing_musts, cooccurrence_readings, rrf_fuse
...
def test_the_ladder_relaxes_compiled_musts_on_relaxable_keys_never_the_users_and_swaps_readings():
    from eigen_kernel.facets.contract_search import recipes
...
def test_survivors_drop_empty_pools_keep_unprobed_and_put_strict_first():
    from eigen_kernel.facets.contract_search import Recipe, survivors
...
def test_blind_hides_source_and_rank_deterministically():
    from eigen_kernel.facets.contract_search import blind
...
def test_merged_order_is_fits_then_partials_then_ungraded_tail_then_nos():
    from eigen_kernel.facets.contract_search import order_by_verdicts, head_precision
...
def test_a_judges_id_is_resolved_however_it_writes_it():
    from eigen_kernel.facets.contract_search import blind, resolve_blind_id
...
def test_relax_steps_go_least_important_first_compiled_before_the_users_and_never_touch_a_scope():
    from eigen_kernel.facets.contract_search import demote, relax_steps
