"""EIGEN_WEB_OPEN_DENOISE — web.py structural + cosine-floor + authority-boost gates.
...
from eigen_kernel.retrieval.web import _DENOISE_SIM_FLOOR, WebRetrievalSource
