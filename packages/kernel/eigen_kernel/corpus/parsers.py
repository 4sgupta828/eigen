...
from eigen_kernel.contract.protocols import Parser
...
class PdfParser:
    ...
    already in the serve image for vision uploads). Engine picked at first use; `EIGEN_PDF_ENGINE`
    ...
    def _engine() -> str:
        import os
        return os.environ.get("EIGEN_PDF_ENGINE", "auto").strip().lower()
