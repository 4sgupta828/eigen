...
from eigen_kernel.research.atoms import IDENTITY_INSTRUCTION
...
EXTRACT_MODEL = os.environ.get("EIGEN_EXTRACT_MODEL", "gpt-4o-mini")
ENTAIL_MODEL = os.environ.get("EIGEN_ENTAIL_MODEL", "gpt-4o")
...
def _client(explicit=None):
    ...
    if not os.environ.get("OPENAI_API_KEY"):
        return None
    from eigen_kernel.providers.openai_llm import OpenAIJsonLLM
