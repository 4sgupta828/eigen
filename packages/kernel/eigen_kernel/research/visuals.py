...
- NON-DUPLICATION: the inline EIGEN_ANSWER_CHARTS path owns NUMERIC encodings (bar/line/pie of
  cited findings); EIGEN_ANSWER_VISUALS owns prose comparison TABLES / ranked lists. This subsystem
