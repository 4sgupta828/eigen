"""Tests for the red-team REFUTER (EIGEN_INTELLIGENCE_CORE / T-B).
...
from eigen_kernel.contract.dto import BlockHit, Locator
from eigen_kernel.providers.embeddings import FakeEmbedder
from eigen_kernel.providers.llm import FakeLLM, LLMResult
...
from eigen_kernel.research.refuter import RefuterQueries, refute_hypothesis

# Reuse the T2 harness pieces (same package).
from eigen_kernel.research.test_intelligence_retrieval import (
    RecordingSource,
    ScriptedLLM,
    _agentic_steps,
)
...
def test_render_undertested_present_and_absent() -> None:
    ...
    (OFF byte-identical)."""
    from eigen_kernel.runtime.research import _render_undertested
