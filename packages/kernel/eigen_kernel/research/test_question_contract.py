"""Evidence Contract stage 3 — the question-contract flag (EIGEN_QUESTION_CONTRACT).
...
from eigen_kernel.research.contract import Contract, build_legs, derive_contract, match_entities
