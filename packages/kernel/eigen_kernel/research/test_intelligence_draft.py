"""Tests for the reliable intelligence draft + line-protocol parser (EIGEN_INTELLIGENCE_CORE, T1).
...
from eigen_kernel.research.intelligence_draft import (Hypothesis, IntelligenceDraft,
