"""Tests for the adversarial FOR/AGAINST pre-seed retrieval (EIGEN_INTELLIGENCE_CORE / T2).
...
from eigen_kernel.research.react import ComposedAnswer  # noqa: E402
...
def test_render_cruxes_present_and_absent() -> None:
    ...
    from eigen_kernel.runtime.research import _render_cruxes
