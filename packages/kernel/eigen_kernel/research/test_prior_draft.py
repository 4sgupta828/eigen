"""draft_prior (EIGEN_PARAMETRIC_LED, T1): one structured call → PriorDraft, fail-safe → None.
...
from eigen_kernel.research.prior_draft import AssertedClaim, PriorDraft, draft_prior
