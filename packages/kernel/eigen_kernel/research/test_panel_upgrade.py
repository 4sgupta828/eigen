...
P2 (EIGEN_PANEL_DEDUP): pooled-claim dedup by (atom_id, normalized quote) + computed-convergence
annotation. P3 (EIGEN_PANEL_CONTRACT): ONE shared contract derived before the specialists (never
