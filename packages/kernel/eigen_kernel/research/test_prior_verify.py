"""Offline tests for the parametric-led DIRECTED VERIFY LOOP (EIGEN_PARAMETRIC_LED, T2).
...
from eigen_kernel.research.prior_draft import AssertedClaim, PriorDraft
...
from eigen_kernel.research.react import _PARAMETRIC_ADDENDUM
from eigen_kernel.runtime.research import _render_unverified_priors
...
def test_off_path_compose_has_no_parametric_addendum() -> None:
    ...
    llm = CapturingScriptedLLM([
        ...
        __import__("eigen_kernel.research.react", fromlist=["ComposedAnswer"]).ComposedAnswer(
