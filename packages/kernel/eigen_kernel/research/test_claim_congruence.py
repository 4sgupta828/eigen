"""Evidence Contract stage 2 — the claim-congruence flag (EIGEN_CLAIM_CONGRUENCE).
...
from eigen_kernel.research.budget import DEFAULT_MAX_LLM_CALLS, BudgetState
from eigen_kernel.research.react import AgentStep, ClaimOut, ComposedAnswer, VerifiedClaim, run_react
