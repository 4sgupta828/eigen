"""Exploratory-legs extension (EIGEN_EXPLORE_LEGS) — Evidence Contract retrieval for
...
from eigen_kernel.research.contract import Contract, build_legs
from eigen_kernel.research.react import run_react
from eigen_kernel.research.test_question_contract import (
    _LEG_TEXT,
    _PROMPT,
    CountingSource,
    RecordingLLM,
