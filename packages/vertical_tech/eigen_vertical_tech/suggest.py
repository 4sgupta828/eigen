...
# The STRATEGIC suggester (EIGEN_STRATEGIC_NEXT): the CENTRAL questions a serious decision-maker
...
def strategic_next_on() -> bool:
    """Flag (default OFF, Rule 20): EIGEN_STRATEGIC_NEXT swaps the follow-up suggester for the
    ...
    return os.environ.get("EIGEN_STRATEGIC_NEXT", "").lower() in ("1", "true", "yes")
