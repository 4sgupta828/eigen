"""Strategic next-questions (EIGEN_STRATEGIC_NEXT): CEO/VC/CTO lens-tagged follow-ups + the
...
def _reload(flag: str, monkeypatch):
    monkeypatch.setenv("EIGEN_STRATEGIC_NEXT", flag)
    import eigen_vertical_tech.suggest as S
    import eigen_vertical_tech.reasoned as R
    importlib.reload(S)
    importlib.reload(R)
    return S, R
