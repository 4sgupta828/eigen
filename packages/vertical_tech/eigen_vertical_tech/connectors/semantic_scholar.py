"""Semantic Scholar connector — S2 Graph API (keyless; optional EIGEN_S2_API_KEY for higher rate).
...
_API_KEY = os.environ.get("EIGEN_S2_API_KEY", "")
...
class SemanticScholarConnector:
    ...
    def __init__(self, *, papers: list[dict] | None = None, page_size: int = 25):
        ...
        # EIGEN_S2_API_KEY the limit is per-key and this rarely triggers.
