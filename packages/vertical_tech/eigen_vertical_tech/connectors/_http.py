...
a 429/503 becomes a paced retry, not a dead ingest job. Set a REAL contact via EIGEN_HTTP_CONTACT
...
_CONTACT = os.environ.get("EIGEN_HTTP_CONTACT", "research@eigen.dev")
USER_AGENT = f"eigen-research/0.1 (+{_CONTACT})"
