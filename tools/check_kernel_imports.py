...
module importing eigen_vertical_* would couple the console to a cartridge).
...
KERNEL_ROOT = Path("packages/kernel/eigen_kernel")
FORBIDDEN_PREFIXES = ("eigen_vertical",)
