"""Tech-synthesis (EIGEN_TECH_SYNTHESIS): compose adds a strategic 'how it works' technical synthesis.
...
from eigen_kernel.research.react import _TECH_SYNTHESIS_ADDENDUM
