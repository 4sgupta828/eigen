...
from eigen_kernel.graph.store import GraphStore, build_adjacency, edge_identity  # noqa: E402
...
def _expander(monkeypatch_env):
    os.environ["EIGEN_GRAPH"] = "1"
    os.environ["EIGEN_GRAPH_EXPAND"] = "late"
...
def test_llm_mapping_fires_only_on_containment_miss_and_validates_vocabulary():
    os.environ["EIGEN_GRAPH_MAP"] = "llm"
    import api.app as appmod
    exp = _expander(None)
    ...
    try:
        ...
        os.environ.pop("EIGEN_GRAPH_MAP", None)
