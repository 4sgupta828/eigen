"""Answer-axes (EIGEN_ANSWER_AXES): compose addresses each asked contract axis + synthesizes.
...
from eigen_kernel.research.react import _AXIS_COMPLETE_ADDENDUM
