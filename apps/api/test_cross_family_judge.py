"""Cross-family judge (EIGEN_CROSS_FAMILY_JUDGE): flag + OPENAI_API_KEY → service.derive_judge_llm.
...
def _set(flag: str, key: str | None) -> None:
    os.environ["EIGEN_CROSS_FAMILY_JUDGE"] = flag
    if key is None:
...
def test_flag_on_with_key_wires_openai_judge() -> None:
    prior_flag = os.environ.get("EIGEN_CROSS_FAMILY_JUDGE", "")
    ...
    try:
        ...
        os.environ["EIGEN_CROSS_FAMILY_JUDGE"] = prior_flag
