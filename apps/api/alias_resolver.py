...
claim's `object_norm` through this map to the canonical node — behind the `EIGEN_ALIAS_RESOLVER` flag.
...
from eigen_kernel.research.claims_first import ENTAIL_MODEL, _client, _json
